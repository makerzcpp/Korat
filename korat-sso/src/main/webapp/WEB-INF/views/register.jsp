...
<div class="w" id="logo">
    <div>
    	<a href="http://www.korat.com/">
    		<img src="http://static.korat.com/images/korat-logo.gif" alt="京东商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://www.korat.com/user/login.html"
    ...
    <div class="mc">
        <form id="personRegForm" method="POST" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="http://static.korat.com/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="http://static.korat.com/js/register/jd.lib.js"></script>
<script type="text/javascript" src="http://static.korat.com/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.korat.com/js/register/jdValidate.js"></script>
<script type="text/javascript" src="http://static.korat.com/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="http://static.korat.com/js/register/jdValidate.regSuccess.js"></script>
