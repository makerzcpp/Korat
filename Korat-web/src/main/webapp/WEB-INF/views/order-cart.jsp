...
<form id="orderForm" class="hide">
    ...
    <input type="hidden" name="payment"
           value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/>"/>
...
<div id="container">
                ...
                <div class="checkout-steps">
                        ...
                        <div class="consignee-list" id="consignee-list1">
                            ...
                            <div id="consignee1" class="list-cont ui-switchable-body">
                                ...
                                <ul class="ui-switchable-panel-main" id="consignee-list">
                                    <!---->
                                    <li class="ui-switchable-panel" id="consignee_index_137617472" selected="selected"
                                        style="cursor: pointer;">
                                        <div class="consignee-item item-selected" consigneeId="137617472"
                                             id="consignee_index_div_137617472">
                                            <b></b>
                                            <div class="user-name">
                                            ...
                                            <div class="op-btns ar">
                                                <a href="#none" class="ftx-05 mr10 setdefault-consignee hide"
                                                   fid="137617472">设为默认地址</a>
                                                <a href="#none" class="ftx-05 mr10 edit-consignee"
                                                   fid="137617472">编辑</a>
				 ...
				 save_Pay(4); ">
                                                ...
                                                <div class="payment-item  online-payment " for="pay-method-4"
                                                    ...
                                                    在线支付 <font class="whiteBarSpanClass hide"
                                ...
                                <div class="shopping-lists" id="shopping-lists">
                                    ...
                                    <div class="shopping-list ABTest">
                                        <div class="goods-list">
                                            ...
                                            <!--满赠套装商品-->
                                            <!--配送方式-->
                                            <h4 class="vendor_name_h" id="0">商家：KORAT商城</h4>
                                            <!--单品开始-->
                                            ...
                                            <div class="goods-suit goods-last">
                                                ...
                                                <c:forEach items="${carts }" var="cart">
                                                    <div class="goods-item goods-item-extra">
                                                        ...
                                                        <div class="p-img">
                                                            <a target="_blank"
                                                               href="http://www.korat.com/item/${cart.itemId}.html"><img
                                                                    src="${cart.itemImage}" alt=""></a>
                                                        </div>
                                                        <div class="goods-msg">
                                                            <div class="p-name">
                                                                <a href="http://www.korat.com/item/${cart.itemId}.html"
                                                                   target="_blank">
                                                                        ${cart.itemTitle }
                                                                </a>
                                                            </div>
                                                            <div class="p-price">
                                                                ...
                                                                <strong>￥<fmt:formatNumber groupingUsed="false"
                                                                                           maxFractionDigits="2"
                                                                                           minFractionDigits="2"
                                                                                           value="${cart.itemPrice / 1000 }"/></strong>
                                                                <!--增加预售金额显示 end-->
                                                                <span class="ml20">
				 			    	x1
				 			</span>
                                        ...
                                        <div class="dis-modes">
                                            ...
                                            <div class="mode-item mode-tab">
                                                <h4>配送方式：（<a id="jd-goods-item" class="ftx-05 alink"
                                                             href="#none">对应商品</a>）</h4>
                                                    ...
                                                    <ul>
                                                        <li class="mode-tab-item " id="jd_shipment_item"
                                                            ...
                                                            <span id="jdShip-span-tip" class="m-txt">京东快递<i
                                                                    class='qmark-icon qmark-tip'
                                                                    data-tips='由京东公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                                                        </li>
                                                        <li class="mode-tab-item hide " id="pick_shipment_item"
                                                            ...
                                                            <span class="m-txt">上门自提<i class="qmark-icon qmark-tip"
                                                                                       data-tips="自提时付款，支持现金、POS刷卡、支票支付<a href='http://help.jd.com/help/question-64.html' target='_blank' class='ftx-05'>查看自提流程</a>"></i></span><b></b>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul class="mode-list">
                                                        <li>
                                                            <div class="fore1" id="jd_shipment_calendar_date"><span
                                                                    class="ftx-03">配送时间：</span>&nbsp;&nbsp;工作日、双休日与节假日均可送货
                                                            </div>
                                                            <div class="fore2 hide" id="jdshipdate_eidt_id"
                                                                 onclick="doEdit311Time()"><a href="#none"
                                                                                              class="ftx-05">修改</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="mode-tab-con hide" id="selfpick_shipment">
                                                    <ul class="mode-list">
                                                        <li>
                                                            <div class="fore1" id="selfpick_name"><span class="ftx-03">自提地点：</span>
                                                            </div>
                                                            <div class="fore2" onclick="doEditPicksite()"><a
                                                                    href="#none" class="ftx-05 picksite-edit">修改</a>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="fore1" id="selfpick_date"><span class="ftx-03">自提时间：</span>
                                                            </div>
                                                            <div class="fore2" onclick="doEditPickSiteDate('0')"><a
                                                                    href="#none" class="ftx-05">修改</a></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!--隐藏自提点开始-->
                                                <div id="picksite_hidediv" class="hide">
                                                    ...
                                                    <div class="form picksite-box">
                                                        <div class="item">
                                                            ...
                                                            <div class="fl">
                                                                <select name="pickRegion" id="pickRegion_select"
                                                                        class="selt pickRegion_select"
                                                                        onchange="doEditPickReigon(this)">
                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div class="fl">
                                                                <div class="pick-sites pick-sites-more" id="pick-sites">
                                                                    ...
                                                                    <!--选中的自提点-->
                                                                    <!--可用自提点-->
                                                                    <div pickid="5456" pickName="浦江智谷自提柜"
                                                                         class="site-item site-item-selected"
                                                                         pickName="浦江智谷自提柜">
                                                                        <div class="site-in-short"
                                                                             style="cursor:pointer"
                                                                             onclick="doSelectPicksite(this)">
                                                                            浦江智谷自提柜
                                                                            <b></b>
                                                                        </div>
                                                                        <div class="field">
 ...
 021-64290343</span>
                                                                            <a href="http://help.jd.com/help/question-66.html#pjzgztg"
                                                                    ...
                                                                    <!--选中的自提点-->
                                                                    <!--可用自提点-->
                                                                    <div pickid="341" pickName="颛桥站" class="site-item"
                                                                         pickName="颛桥站">
                                                                        <div class="site-in-short"
                                                                             style="cursor:pointer"
                                                                             onclick="doSelectPicksite(this)">
                                                                        ...
                                                                        <div class="field">
                                                                            ...
                                                                            <a href="http://help.jd.com/help/question-101.html#shanghaizhuanqiao"
                                                                               target="_blank" class="ftx-05 map-link">详细地图</a>
                                                                        </div>
                                                                        <div class="clr"></div>
                                                                    </div>
                                                                    ...
                                                                    <!--选中的自提点-->
                                                                    <!--可用自提点-->
                                                                    <div pickid="1411" pickName="金州站" class="site-item"
                                                                         pickName="金州站">
                                                                        <div class="site-in-short"
                                                                             style="cursor:pointer"
                                                                             onclick="doSelectPicksite(this)">
                                                                        ...
                                                                        <div class="field">
                                                                            ...
                                                                            <a href="http://help.jd.com/help/question-101.html#shanghaijinzhou"
                                                                               target="_blank" class="ftx-05 map-link">详细地图</a>
                                                                        </div>
                                                                        <div class="clr"></div>
                                                                    </div>
                                                                    ...
                                                                    <!--选中的自提点-->
                                                                    <!--可用自提点-->
                                                                    <div pickid="4532" pickName="新梅莘苑自提柜"
                                                                         class="site-item" pickName="新梅莘苑自提柜">
                                                                        <div class="site-in-short"
                                                                             style="cursor:pointer"
                                                                             onclick="doSelectPicksite(this)">
                                                                            新梅莘苑自提柜
...
" target="_blank" class="ftx-05 map-link">详细地图</a>
                                                                    ...
                                                                    <!--选中的自提点-->
                                                                    <!--可用自提点-->
                                                                    <div pickid="4533" pickName="海德名园自提柜"
                                                                         class="site-item" pickName="海德名园自提柜">
                                                                        <div class="site-in-short"
                                                                             style="cursor:pointer"
                                                                             onclick="doSelectPicksite(this)">
                                                                            海德名园自提柜
                                                                        ...
                                                                        <div class="field">
                                                                            ...
                                                                            <a href="http://help.jd.com/help/question-66.html#haidemingyuan"
                                                                               target="_blank" class="ftx-05 map-link">详细地图</a>
                                                                        </div>
                                                                        <div class="clr"></div>
                                                                    </div>
                                                                ...
                                                                <div class="pick-more">
                                                                    <span class="selfpick_more_link open ftx05"
                                                                          style="cursor:pointer;"
                                                                          onclick="open_MorePicksite(this)">展开更多<b></b></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="item">
                                                            ...
                                                            <div class="fl">
                                                                <div class="op-btns">
                                                                    ...
                                                                    <a class="btn-9 ml10"
                                                                       href="javascript:jQuery.closeDialog();">取消</a>
                                                                </div>
                                                                <div class="ftx-03 mt10">自提时付款，支持现金、POS刷卡、支票支付 <a
                                                                        class="ftx-05"
                                                                        href="http://help.jd.com/help/question-64.html#help170"
                                                                        target="_blank">查看自提流程</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="pickSiteShipDate" class="hide">
                                                    <div class="date-box">
                                                        <div class="date-list">
                                                            <ul>
                                                                <li class="li_pick_shipment" date="2015-03-24"
                                                                    picksite_date="3-24" picksite_weekDay="周二"
                                                                    onclick="doSwithPickShipDate('0',this)">
                                                                    3-24
                                                                    <span class="data">周二</span>
                                                                </li>
                                                                <li class="li_pick_shipment" date="2015-03-25"
                                                                    picksite_date="3-25" picksite_weekDay="周三"
                                                                    onclick="doSwithPickShipDate('0',this)">
                                                                    3-25
                                                                    <span class="data">周三</span>
                                                                </li>
                                                                <li class="li_pick_shipment" date="2015-03-26"
                                                                    picksite_date="3-26" picksite_weekDay="周四"
                                                                    onclick="doSwithPickShipDate('0',this)">
                                                                    3-26
                                                                    <span class="data">周四</span>
                                                                </li>
                                                                <li class="li_pick_shipment" date="2015-03-27"
                                                                    picksite_date="3-27" picksite_weekDay="周五"
                                                                    onclick="doSwithPickShipDate('0',this)">
                                                                    3-27
                                                                    <span class="data">周五</span>
                                                                </li>
                                                                <li class="li_pick_shipment" date="2015-03-28"
                                                                    picksite_date="3-28" picksite_weekDay="周六"
                                                                    onclick="doSwithPickShipDate('0',this)">
                                                                    3-28
                                                        ...
                                                        <div class="op-btns mt20 ac">
                                                            <a href="#none" onclick="doSavePickShipDate('0')"
                                                               class="btn-9">保存</a>
                                                            <a href="javascript:jQuery.closeDialog();"
                                                    ...
                                                    <div class="tooltip-goods">
                                                        ...
                                                        <div class="goods-items">
                                                            <div class="goods-item">
                                                                <div class="p-img">
                                                                    <a href="#none"><img
                                                                            src="http://img14.360buyimg.com/N4/jfs/t274/191/1323012102/354214/23ee9085/5437845cN5d6b6205.jpg"
                                                                            alt=""></a>
                                                                </div>
                                                                <div class="p-name">
                                        ...
                                        <div class="freight-cont">
                                            <strong class="ftx-01" style="color:#666" freightByVenderId="0"
                                                    popJdShipment="false">免运费</strong>
                                        </div>
                                    </div> <!--shopping-list 结束-->
                                    <form id="skuAndShipment_submit_form" method='post' action=''>
                                        <input type="hidden" id="saveParam_paymentId" name="saveParam.paymentId"/>
                                        <!--支付方式id-->
                                        <!-- 京东配送 -->
                                        <input type="hidden" id="saveParam_jdShipmentType"
                                               name="saveParam.jdShipmentType" value=""/><!--京东配送-->
                                        <input type="hidden" id="saveParam_jdShipTime" name="saveParam.jdShipTime"
                                               value="3"/><!-- 区分工作日，311，411-->
                                        <input type="hidden" id="saveParam_jdPayWayId" name="saveParam.jdPayWayId"
                                               value="0"/><!--货到付款方式-->
                                        <input type="hidden" id="saveParam_jdCheckType" name="saveParam.jdCheckType"
                                               value="2"/><!--如果是支票这个只是写死的[仅支持京东上门自取]-->
                                        <input type="hidden" id="saveParam_jdBigItemShipTimeOffset"
                                               name="saveParam.jdBigItemShipTimeOffset" value="0"/><!--京东大家电安装时间偏移量-->
                                        <input type="hidden" id="saveParam_jdBigItemInstallTimeOffest"
                                               name="saveParam.jdBigItemInstallTimeOffest" value="0"/>
                                        <!--京东大家电配送时间偏移量-->
                                        <!--311-->
                                        <input type="hidden" id="saveParam_promiseType" name="saveParam.promiseType"/>
                                        <!--1表示311类型，2表示411-->
                                        <input type="hidden" id="saveParam_promiseDate" name="saveParam.promiseDate"/>
                                        <!--日历-->
                                        <input type="hidden" id="saveParam_promiseTimeRange"
                                               name="saveParam.promiseTimeRange"/><!--波次-->
                                        <input type="hidden" id="saveParam_promiseSendPay"
                                               name="saveParam.promiseSendPay"/><!--选择的sendpay-->
                                        <input type="hidden" id="saveParam_promiseMessage"
                                               name="saveParam.promiseMessage"/><!--预约配送提示-->
                                        <!--411-->
                                        <input type="hidden" id="saveParam_jdBigItemNightShip"
                                               name="saveParam.jdBigItemNightShip" value="false"/><!--大家电是否支持晚间配送-->
                                        <!--京东第三方配送-->
                                        <input type="hidden" id="saveParam_otherShipmentType"
                                               name="saveParam.otherShipmentType" value=""/><!--京东第三方配送-->
                                        <input type="hidden" id="saveParam_otherShipTime" name="saveParam.otherShipTime"
                                               value=""/><!--区分工作日，311，411-->
                                        <input type="hidden" id="saveParam_otherBigItemShipOffset"
                                               name="saveParam.otherBigItemShipOffset" value=""/><!--京东大家电安装时间偏移量-->
                                        <input type="hidden" id="saveParam_otherBigItemInstallTimeOffset"
                                               name="saveParam.otherBigItemInstallTimeOffset" value=""/>
                                        <!--京东大家电配送时间偏移量-->

                                        <!-- 第三方配送 -->
                                        <input type="hidden" id="saveParam_sopOtherShipmentType"
                                               name="saveParam.sopOtherShipmentType" value=""/><!--第三方配送-->
                                        <!-- 自提方式 -->
                                        <input type="hidden" id="saveParam_pickShipmentType"
                                               name="saveParam.pickShipmentType" value=""/>
                                        <!--自提方式-->
                                        <input type="hidden" id="saveParam_pickSiteId" name="saveParam.pickSiteId"
                                               value="5456"/><!--自提点-->
                                        <input type="hidden" id="saveParam_pickDate" name="saveParam.pickDate"
                                               value="2015-03-24"/><!--自提时间-->
                                        <input type="hidden" id="saveParam_pickSiteNum" name="saveParam.pickSiteNum"
                                               value="5"/><!--默认5个-->
                                        <input type="hidden" id="saveParam_pickRegionId" name="saveParam.pickRegionId"/>
                                        <!--搜索区域-->
                                    </form>
                                    <input type="hidden" id="mainSkuIdAndNums" value="11555193_2,"/>
                                    <!--icon隐藏域,用于更新库存-->
                                    ...
                                    <input type="hidden" id="last_sel_promiseTimeRange" value=""/>
                                    <!--icon隐藏域，记录上次选中的时间段-->
                                    <input type="hidden" id="last_sel_promiseSendPay" value=""/>
                                    <!--icon隐藏域，记录上次选中的sendpay-->
                                    <input type="hidden" id="shipment411_sendpay" value=""/><!--411sendpay-->
                                    <input type="hidden" id="shipment_support_type" value=""/>
                                    <!--icon隐藏域，当前311和411支持的类型，0表示311,411都不支持,1表示只支持311,2表示只支持411,3表示311,411都支持-->
                                    <input type="hidden" id="shipment_select_support" value=""/>
                                    <!--icon隐藏域，当前311和411选中的是哪一个，1表示选中311,2表示选中411-->
                                    <input type="hidden" id="shipment_cur411_support" value=""/>
                                    ...
                                    <input type="hidden" id="temp_pick_sel_regionid" value=""/>
                                    <!--icon隐藏域，临时存放选中的自提点区域ID-->
                                    ...
                                    <input type="hidden" id="is_refresh_installdate" value=""/>
                                    <!--icon隐藏域，是否要刷新商品安装时间-->
        ...
        &nbsp; </span> 明细
                    ...
                    <c:forEach items="${carts}" var="cart">
                        <c:set var="sum" value="${sum+cart.itemPrice}"/>
                    ...
                    <div class="order-summary">
                        ...
                        <div class="statistic fr">
                            <div class="list">
                                <span><em class="ftx-01">${count}</em> 件商品，总商品金额：</span>

                                <em class="price" id="warePriceId">￥${sum}</em>
                            </div>

                            <div class="list">
                                <span>返现：</span>
                                <em class="price" id="cachBackId" > -￥0.00</em>
                            </div>
                            <div class="list">
                                <span>运费：</span>
                            ...
                            <div class="list">
                                <span>应付总额：</span>
                                <em class="price" id="sumPayPriceId">${sum}</em>
                            </div>
                        </div>
                        <div class="clr"></div>
                    </div>
                    ...
                    <div class="ui-ceilinglamp checkout-buttons">
                        ...
                        <div class="sticky-wrap">
                            <div class="inner">
                                ...
                                <span class="total">应付总额：<strong id="payPriceId">${sum}</strong>
        ...
        <div id="backpanel">
            <div id="backpanel-inner" class="hide">
                <div class="bp-item bp-item-survey">
                    <a href="http://surveys.jd.com/index.php?r=survey/index/sid/584338/lang/zh-Hans" class="survey"
