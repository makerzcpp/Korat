...
<link href="/js/kindeditor-4.1.10/themes/default/default.css" type="text/css"
      rel="stylesheet">
...
<script type="text/javascript">
    var itemAddEditor;
    $(function () {
        itemAddEditor = KORAT.createEditor("#itemAddForm [name=desc]");
        KORAT.init({
            fun: function (node) {
                KORAT.changeItemParam(node, "itemAddForm");
            }
        });
    });
