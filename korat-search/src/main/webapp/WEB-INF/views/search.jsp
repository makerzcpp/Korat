...
<link rel="stylesheet" type="text/css" href="http://static.korat.com/css/psearch20131008.css" media="all" />
<link rel="stylesheet" type="text/css" href="http://static.korat.com/css/psearch.onebox.css" media="all" />
<link rel="stylesheet" type="text/css" href="http://static.korat.com/css/pop_compare.css" media="all" />
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://www.korat.com/item/${item.id}.html">
	...
	<div class="service">由 KORAT 发货</div>
	<div class="extra">
...
<!-- footer end -->
<script type="text/javascript" src="http://static.korat.com/js/jquery.hashchange.js"></script>
<script type="text/javascript" src="http://static.korat.com/js/search_main.js"></script>
